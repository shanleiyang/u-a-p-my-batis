...
import com.sgcc.uap.kernel.io.OsgiBundleResourcePatternResolver;
...
public class MapperScannerConfigurer implements BeanDefinitionRegistryPostProcessor, InitializingBean, ApplicationContextAware, BeanNameAware {
  ...
  public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) {
    ...
    /*******************update by shanleiyang 2018.06.14****start***************/
    if (this.applicationContext instanceof ModuleXMLWebApplicationContext) {
		ModuleXMLWebApplicationContext moduleContext = (ModuleXMLWebApplicationContext)applicationContext;
		scanner.setResourceLoader(new OsgiBundleResourcePatternResolver(moduleContext.getBundle()));
	} else {
		scanner.setResourceLoader(this.applicationContext);
	}
    /*******************update by shanleiyang 2018.06.14****end***************/
