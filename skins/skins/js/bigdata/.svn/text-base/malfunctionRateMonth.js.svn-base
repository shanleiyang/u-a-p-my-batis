 ...
 * 当月故障率或累计故障率环形图
 */
var MalfunctionRateMonth = function(dom,tagNo,theme,opts) {
	this.dom = dom;
	this.theme = theme;
	this.opts = opts;
	this.chart = null;
...
MalfunctionRateMonth.prototype = {
		optionFunc:function(fillColor){
			return {
				graphic: {
			        elements: [{
			            type: 'circle',
